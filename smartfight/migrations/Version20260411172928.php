...
final class Version20260411172928 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE combattant (id INT AUTO_INCREMENT NOT NULL, nickname VARCHAR(255) NOT NULL, nationalite VARCHAR(255) NOT NULL, weight_class VARCHAR(255) NOT NULL, wins INT NOT NULL, losses INT NOT NULL, draws INT NOT NULL, discipline VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
