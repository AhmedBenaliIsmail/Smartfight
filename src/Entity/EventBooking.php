...
class EventBooking
{
    ...
    public const TYPE_VIP_RINGSIDE = 'VIP_RINGSIDE';
    public const TYPE_PREMIUM_LOWER = 'PREMIUM_LOWER';
    public const TYPE_REGULAR_SEATING = 'REGULAR_SEATING';
    public const TYPE_BALCONY = 'BALCONY';
    public const TYPE_STANDING_ROOM = 'STANDING_ROOM';
    ...
    #[ORM\Column(name: 'ticket_type', type: 'string', length: 30)]
    private string $ticketType = self::TYPE_REGULAR_SEATING;
