...
class FanPreference
{
    ...
    #[ORM\JoinColumn(name: 'fan_id', referencedColumnName: 'userId', nullable: false)]
    private User $fan;
    ...
    #[ORM\JoinColumn(name: 'favorite_fighter_id', referencedColumnName: 'fighterId', nullable: true)]
