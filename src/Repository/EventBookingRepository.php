...
class EventBookingRepository extends ServiceEntityRepository
{
    ...
    public function findConfirmedEventIdsByUser(int $userId): array
    {
    ...
    public function countConfirmedByUser(int $userId): int
    {
        return (int) $this->createQueryBuilder('b')
    ...
    public function getDailyRevenueLast7Days(): array
    {
        $conn = $this->getEntityManager()->getConnection();
        $sql = '
